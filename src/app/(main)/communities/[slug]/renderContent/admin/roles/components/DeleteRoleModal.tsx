...
interface DeleteRoleModalProps {
    ...
    setShowDeleteRoleModal: React.Dispatch<React.SetStateAction<boolean>>;
...
const DeleteRoleModal = ({ showDeleteRoleModal, setShowDeleteRoleModal, roleToDelete, setRoleToDelete, onConfirmDelete }: DeleteRoleModalProps) => {
    return (
        <AnimatePresence>
                    ...
                    >
                        <div className="p-6 border-b border-gray-700">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-white">Eliminar Rol</h2>
                        ...
                        <div className="p-6">
                            <div className="mb-6">
                                <p className="text-white mb-2">
                                    ¿Estás seguro de que quieres eliminar el rol <strong>{roleToDelete.role_name}</strong>?
                                </p>
                                <p className="text-slate-400 text-sm mb-4">
                                    Los usuarios con este rol serán reasignados automáticamente al rol <strong>Miembro</strong> por defecto.
                                </p>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <ul className="text-red-300 text-xs space-y-1">
                                                <li>• Todos los usuarios con este rol perderán sus permisos actuales</li>
                                                <li>• Se revocará el acceso a contenido específico del rol</li>
