...
import { ROLES_LENGTH } from "../../lib/constants/module.constants";

interface ModuleRolesFieldProps {
    control: ModuleFieldProps['control'];
    roles: Role[];
}

const ModuleRolesField = ({ control, roles }: ModuleRolesFieldProps) => {
...
export default ModuleRolesField;