...
const MyCommunitiesSection = ({ communities }: { communities: MyCommunities[] }) => {
    ...
    const { isCreating, communityName, hasCreationError, lastFormData, handleCreationError, handleCreationComplete, handleCreateCommunity } = useCommunityActions(setIsDialogOpen);
    ...
    console.log({ hasCreationError, lastFormData });
    ...
    return (
        <>
            ...
            {data && <CreateCommunityModal communityData={data} open={isDialogOpen} initialData={hasCreationError ? lastFormData : null} onOpenChange={handleCloseDialog} onSubmit={handleSubmitCommunity} />
            }
            ...
            <LoadingOverlay
                ...
                errorDescription={
                    hasCreationError ? hasCreationError : `No pudimos crear la comunidad. Por favor, intenta de nuevo.`
                }
