...
export interface PricingStepProps {
  ...
  onAddBenefit: (planIndex: number) => void;
  onRemoveBenefit: (planIndex: number, benefitIndex: number) => void;
  onUpdatePlan: (
    index: number,
    field: PlanFieldKey,
...
export interface CreateCommunityModalProps {
  ...
  initialData?: CreateCommunityForm | null;
}
...
export interface CommunityFormHandlers {
  ...
  addBenefitToPlan: (planIndex: number) => void;
  removeBenefitFromPlan: (planIndex: number, benefitIndex: number) => void;
  canAddPlan: () => boolean;
  canRemovePlan: () => boolean;
  updatePlan: (
    index: number,
