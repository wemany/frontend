...
const PricingStep = ({ form, communityData, canAddPlan, canRemovePlan, onAddPlan, onRemovePlan, onAddFeature, onRemoveFeature, onUpdatePlan }: PricingStepProps) => {
    const { watch } = form
            ...
            <div className="space-y-4">
                {plans.map((plan, index) => (
                    <PlanCard
                        ...
                        onAddFeature={() => onAddFeature(index)}
                        onRemoveFeature={(featureIndex) => onRemoveFeature(index, featureIndex)}
